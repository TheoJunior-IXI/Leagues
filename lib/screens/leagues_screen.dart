...
import 'package:sports_app/data/models/get_leagues_model.dart';
import 'package:sports_app/data/reposetories/get_leagues_repo.dart';
...
class _LeaguesScreenState extends State<LeaguesScreen> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(title: 'sports app', home: 
    Scaffold(
